...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--minhash-threshold", type=float, default=0.7, help="Jaccard threshold for MinHash LSH.")
    ...
    parser.add_argument("--embedding-threshold", type=float, default=0.85, help="Cosine similarity threshold for embeddings.")
    parser.add_argument("--embedding-batch-size", type=int, default=32, help="Embedding encoder batch size.")
    parser.add_argument("--embedding-device", help="Force embedding model device (e.g. cuda or cpu).", default=None)
    ...
    parser.add_argument("--max-group-size", type=int, default=25, help="Maximum fact count sent to the LLM per candidate group.")
