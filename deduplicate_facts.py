...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--minhash-threshold", type=float, default=0.9, help="Jaccard threshold for MinHash LSH.")
    ...
    parser.add_argument("--embedding-threshold", type=float, default=0.9, help="Cosine similarity threshold for embeddings.")
